    ...
    <div class="q-ma-xl loginWindow">
      <div class="row login ">
        <div class="row col-6 bg-grey-6 full-height justify-center">
          <q-img class="full-height" :style="{ 'filter': darkStore.dark ? 'blur(0px) grayscale(20%)' : '' }" fit="cover"
            position="0 0" :src="darkStore.dark ? 'src/assets/pic/login_dark.jpg' : 'src/assets/pic/login.jpg'"
            loading="eager">
          </q-img>
        </div>
        <div class="col-6 relative-position full-height form">
          ...
          <q-form class="absolute-center q-pb-xl" style="width: 65%;" @submit="handleLogin">
            ...
            <TransitionGroup name="login" tag="div" style="position: relative;">
              ...
              <q-banner class="absolute full-height" style="background-color: transparent; margin-top: -10px;" v-if="errorTip">
