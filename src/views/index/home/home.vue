...
<template>
  ...
  <div class="full-width row gt-sm" style="flex: 1;">
    <div class="col-md-6 col-xs-12 row q-py-sm q-pr-sm" style="flex: 1;">
      <div class="col-12 q-pa-lg blocks" style="display: flex; flex-direction: column;">
        ...
        <div class="q-mb-md" style="width: 100%;display: flex; flex: 1;">
          <infoCard class="fit" :info="serverInfoStore.serverMsg['swap']" :title="'swap'" />
        </div>
